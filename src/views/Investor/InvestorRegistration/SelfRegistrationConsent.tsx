 ...
 * Shows data consent management before OTP is sent
 */
const SelfRegistrationConsent: React.FC = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const { email, registerAs } = location.state || {};
        ...
        <div className="container">
          <div className="registration-split-layout consent-layout-split">
            ...
            <div className="left-panel">
              {/* Welcome text */}
              {/* <div className="lgf4_Left_content mb-3" style={{ width: '100%', maxWidth: '700px' }}>
              ...
              <div className="consent-container" style={{ width: '100%', maxWidth: '700px', margin: '0 auto', textAlign: 'left' }}>
                <h2 className="mt-0">Individual Investor Privacy & Consent Notice</h2>
...
export default SelfRegistrationConsent;
